...
def test_flatten_produces_self_contained_cellml_2_0():
...
def test_flattened_metadata_matches_the_reference_flat_model():
...
def test_flatten_reports_missing_sister_files():
...
def test_upload_unflattened_bundle_flattens_and_registers(client):
...
def test_upload_bundle_missing_sisters_returns_422(client):
